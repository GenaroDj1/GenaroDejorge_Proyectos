import os #permite trabajar con las rutas del sist operativo y config variables de entorno.
import mysql.connector #driver para conectar son mysql
from flask import g
...
#El get_db en caso de que la coneccion no exista la vuelve a generar.
